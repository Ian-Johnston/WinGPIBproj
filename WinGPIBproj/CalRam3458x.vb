...
Partial Class Formtest
    ...
    Private Sub Button3458ACalRamBrowse_Click(
    sender As Object,
    e As EventArgs) Handles Button3458ACalRamBrowse.Click
        ...
        Try
            ...
            If allZero Then
                ...
                Label3458ACalRamFileInfo.Text =
                "INVALID CALRAM FILE - ALL BYTES ARE 00"
            ...
            If allFF Then
                ...
                Label3458ACalRamFileInfo.Text =
                "INVALID CALRAM FILE - ALL BYTES ARE FF"
            ...
            Dim reference40K As Double =
            ReadFloat64BE(bytes, &H60000)

            Dim reference7V As Double =
            ReadFloat64BE(bytes, &H60008)

            ' Reject invalid IEEE-754 values.
            If Double.IsNaN(reference40K) OrElse
           Double.IsInfinity(reference40K) Then

                Label3458ACalRamFileInfo.Text =
                "INVALID CALRAM FILE - INVALID 40K REFERENCE"
            ...
            If Double.IsNaN(reference7V) OrElse
           Double.IsInfinity(reference7V) Then

                Label3458ACalRamFileInfo.Text =
                "INVALID CALRAM FILE - INVALID 7V REFERENCE"
            ...
            If reference40K < 39921.5 OrElse
           reference40K > 40079.2 Then

                Label3458ACalRamFileInfo.Text =
                "INVALID CALRAM FILE - 40K REFERENCE OUT OF RANGE"
                ...
                vbCrLf & vbCrLf &
                "Value: " &
                reference40K.ToString(
                    "0.000000",
                    CultureInfo.InvariantCulture) &
                vbCrLf &
                "Expected: 39921.5 TO 40079.2",
                "HP 3458A CalRAM",
            ...
            If reference7V < 6.5 OrElse
           reference7V > 7.5 Then

                Label3458ACalRamFileInfo.Text =
                "INVALID CALRAM FILE - 7V REFERENCE OUT OF RANGE"
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(
            "The CalRAM file could not be checked." &
            vbCrLf & vbCrLf &
            ex.Message,
            "HP 3458A CalRAM",
            MessageBoxButtons.OK,
    ...
    Private Function Get3458AFirmwareMajor(
    firmwareReply As String,
    ByRef firmwareMajor As Integer) As Boolean
        ...
        Try
            ...
            Dim cleanReply As String =
                firmwareReply.ToUpperInvariant().
                Replace("REV", "").
                Trim()

            Dim firstPart As String =
                cleanReply.Split(","c)(0).Trim()
    ...
    Private Sub Button3458ACalRamTestWrite_Click(
    sender As Object,
    e As EventArgs) Handles Button3458ACalRamTestWrite.Click
        ...
        Try
            ...
            If ButtonDev1Run.Enabled = False Then
                ...
                Label3458ACalRamStatus.Text =
                "DEVICE 1 IS NOT STARTED"

                Label3458AFirmware.Text =
                "NOT DETECTED"
            ...
            Label3458ACalRamStatus.Text =
            "STB MASK, POLLING, CALRAM PRE-RUN"
            ...
            lineCountCalRam =
            CalRam3458APreRun.Lines.Count

            For index As Integer = 0 To lineCountCalRam - 1

                Dim command As String =
                CalRam3458APreRun.Lines(index).Trim()
            ...
            If CalRam3458AInstrumentID.IndexOf(
            "HP3458A",
            StringComparison.OrdinalIgnoreCase) < 0 Then

                Throw New InvalidOperationException(
                "The connected instrument did not identify as an HP 3458A." &
                vbCrLf &
                "ID response: " &
                CalRam3458AInstrumentID)
            ...
            Query3458ACalRam("REV?")

            If Not Get3458AFirmwareMajor(
            CalRam3458AFirmwareResponse,
            CalRam3458AFirmwareMajor) Then

                Label3458AFirmware.Text =
                "UNSUPPORTED"

                Throw New InvalidOperationException(
                "Unsupported HP 3458A firmware." &
                vbCrLf &
                "REV response: " &
                CalRam3458AFirmwareResponse)
            ...
            Label3458AFirmware.Text =
            CalRam3458AFirmwareResponse.ToUpperInvariant()

            ProgressBar3458ACalRam.Value = 40

            ' Read the original first CalRAM word.
            Label3458ACalRamStatus.Text =
            "READING ORIGINAL CALRAM WORD"

            Me.Refresh()

            Dim originalHighByte As Integer =
            MRead3458AHighByte(CalRam3458ABase)

            Dim originalLowByte As Integer =
            MRead3458AHighByte(CalRam3458ABase + 2)

            Dim originalWord As Integer =
            (originalHighByte << 8) Or originalLowByte

            ProgressBar3458ACalRam.Value = 55

            ' Write exactly the same value back.
            Label3458ACalRamStatus.Text =
            "PERFORMING UNCHANGED TEST WRITE"

            Me.Refresh()

            Dim jsrOK As Boolean =
            Write3458ACalRamWord(
                CalRam3458ABase,
                originalWord)
            ...
            Label3458ACalRamStatus.Text =
            "VERIFYING TEST WRITE"

            Me.Refresh()

            Dim readbackHighByte As Integer =
            MRead3458AHighByte(CalRam3458ABase)

            Dim readbackLowByte As Integer =
            MRead3458AHighByte(CalRam3458ABase + 2)

            Dim readbackWord As Integer =
            (readbackHighByte << 8) Or readbackLowByte

            If Not jsrOK Then

                Throw New InvalidOperationException(
                "The NMI write routine returned an instrument error.")
            ...
            If readbackWord <> originalWord Then
                ...
                Throw New InvalidOperationException(
                "Test-write verification failed." &
                vbCrLf & vbCrLf &
                "Original: 0x" &
                originalWord.ToString("X4") &
                vbCrLf &
                "Readback: 0x" &
            ...
            MessageBox.Show(
            "The unchanged CalRAM test write passed." &
            vbCrLf & vbCrLf &
            "Original word: 0x" &
            originalWord.ToString("X4") &
            vbCrLf &
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(
            "The HP 3458A CalRAM test write failed." &
            vbCrLf & vbCrLf &
            ex.Message,
            "HP 3458A CalRAM",
            MessageBoxButtons.OK,
        ...
        Finally
            ...
            Button3458ACalRamTestWrite.Enabled =
    ...
    Private Sub Button3458ACalRamAbort_Click(
    sender As Object,
    e As EventArgs) Handles Button3458ACalRamAbort.Click

        If CalRam3458AWriteInProgress OrElse
       CalRam3458AVerifyInProgress Then
    ...
    Private Sub CheckBox3458ACalRamWriteConfirm_CheckedChanged(
    sender As Object,
    e As EventArgs) Handles CheckBox3458ACalRamWriteConfirm.CheckedChanged

        Button3458ACalRamWrite.Enabled =
        Label3458ACalRamStatus.Text = "TEST WRITE PASSED" AndAlso
        CheckBox3458ACalRamWriteConfirm.Checked AndAlso
        TextBox3458ACalRamConfirm.Text.
            Trim().
    ...
    Private Sub TextBox3458ACalRamConfirm_TextChanged(
    sender As Object,
    e As EventArgs) Handles TextBox3458ACalRamConfirm.TextChanged
    ...
    Private Sub TextBox3458ACalRamConfirm_KeyDown(
    sender As Object,
    e As KeyEventArgs) Handles TextBox3458ACalRamConfirm.KeyDown
    ...
    Private Function Get3458ACalRamFirmwareConfig(
    firmwareMajor As Integer) As CalRam3458AFirmwareConfig
        ...
        Select Case firmwareMajor
            ...
            Case Else
                ...
                Throw New InvalidOperationException(
                    "Unsupported HP 3458A firmware revision.")
    ...
    Private Function MRead3458AWord(address As Integer) As Integer
        ...
        Dim response As String =
            Query3458ACalRam("MREAD " & address.ToString(
                CultureInfo.InvariantCulture))
        ...
        If Not Integer.TryParse(
            ...
            Throw New InvalidOperationException(
                "Invalid MREAD response: " & response)
        ...
        If signedValue < -32768 OrElse signedValue > 32767 Then
            ...
            Throw New InvalidOperationException(
                "MREAD response outside the 16-bit range: " & response)
    ...
    Private Sub MWrite3458AWords(
    startAddress As Integer,
    words As IEnumerable(Of Integer))
    ...
    Private Function Run3458AJSR(
    address As Integer,
    waitMilliseconds As Integer) As String
    ...
    Private Sub Set3458ANmiMagicWords(
    config As CalRam3458AFirmwareConfig)
    ...
    Private Sub Write3458ASingleWordCallback()
        ...
        MWrite3458AWords(
            CalRam3458ACallbackBase,
            callbackWords)

    End Sub


    Private Function Build3458ACallbackSetupWords(
    config As CalRam3458AFirmwareConfig) As List(Of Integer)
    ...
    Private Function Build3458ANmiTriggerWords(
    config As CalRam3458AFirmwareConfig) As List(Of Integer)
    ...
    Private Function Write3458ACalRamWord(
    physicalAddress As Integer,
    wordValue As Integer) As Boolean

        Dim config As CalRam3458AFirmwareConfig =
            Get3458ACalRamFirmwareConfig(
                CalRam3458AFirmwareMajor)
        ...
        mainCode.AddRange(
            Build3458ACallbackSetupWords(config))

        mainCode.AddRange(
            Build3458ANmiTriggerWords(config))
    ...
    Private Function Write3458ACalRamBlock(
    config As CalRam3458AFirmwareConfig,
    startWord As Integer,
    wordCount As Integer) As Boolean

        If wordCount < 1 OrElse
           wordCount > CalRam3458ABlockWords Then

            Throw New ArgumentOutOfRangeException(
                NameOf(wordCount),
                "CalRAM block size must be between 1 and 128 words.")

        End If

        Dim stagingAddress As Integer =
            CalRam3458ADataBase + (startWord * 2)

        Dim calRamAddress As Integer =
            CalRam3458ABase + (startWord * 4)
        ...
        If displacement < Short.MinValue OrElse
           displacement > Short.MaxValue Then

            Throw New InvalidOperationException(
                "Calculated DBRA displacement is outside the 16-bit range.")
    ...
    Private Sub Set3458ACalRamWriteProgress(
    value As Integer,
    statusText As String)

        ProgressBar3458ACalRam.Value =
            Math.Max(
                ProgressBar3458ACalRam.Minimum,
                Math.Min(
                    ProgressBar3458ACalRam.Maximum,
                    value))
    ...
    Private Sub Button3458ACalRamWrite_Click(
    sender As Object,
    e As EventArgs) Handles Button3458ACalRamWrite.Click
        ...
        If Label3458ACalRamStatus.Text <> "TEST WRITE PASSED" Then
            ...
            MessageBox.Show(
                "A successful TEST WRITE is required before writing CalRAM.",
                "HP 3458A CalRAM",
                MessageBoxButtons.OK,
                MessageBoxIcon.Warning)
        ...
        If Not CheckBox3458ACalRamWriteConfirm.Checked Then
            ...
            MessageBox.Show(
                "You must tick the CalRAM overwrite confirmation box.",
                "HP 3458A CalRAM",
                MessageBoxButtons.OK,
                MessageBoxIcon.Warning)
        ...
        If TextBox3458ACalRamConfirm.Text.
            ...
            MessageBox.Show(
                "The CalRAM confirmation text is not correct.",
                "HP 3458A CalRAM",
                MessageBoxButtons.OK,
                MessageBoxIcon.Warning)
        ...
        Dim fileName As String =
            TextBox3458ACalRamWriteFile.Text.Trim()

        If fileName = "" OrElse
   Not System.IO.File.Exists(fileName) Then

            MessageBox.Show(
                "The selected CalRAM file cannot be found.",
                "HP 3458A CalRAM",
                MessageBoxButtons.OK,
                MessageBoxIcon.Warning)
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(
                "The CalRAM file could not be read." &
                vbCrLf & vbCrLf &
                ex.Message,
                "HP 3458A CalRAM",
                MessageBoxButtons.OK,
        ...
        If calRamData.Length <> 2048 Then
            ...
            MessageBox.Show(
                "The selected CalRAM file is no longer exactly 2048 bytes.",
                "HP 3458A CalRAM",
                MessageBoxButtons.OK,
                MessageBoxIcon.Error)
        ...
        Dim confirmation As DialogResult =
            MessageBox.Show(
                "This will overwrite the complete calibration RAM in the " &
                "connected HP 3458A." &
                vbCrLf & vbCrLf &
                "Do not switch off the meter or interrupt the GPIB connection." &
                vbCrLf & vbCrLf &
                "Continue with the CalRAM write?",
                "CONFIRM HP 3458A CALRAM WRITE",
        ...
        Try
            ...
            For wordIndex As Integer = 0 To 1023
                ...
                Dim wordValue As Integer =
                    (CInt(calRamData(wordIndex * 2)) << 8) Or
                    CInt(calRamData((wordIndex * 2) + 1))

                MWrite3458AWord(
                    CalRam3458ADataBase + (wordIndex * 2),
                    wordValue)

                If wordIndex Mod 8 = 0 Then

                    Dim progress As Integer =
                        CInt((wordIndex / 1023.0) * 50.0)
            ...
            For Each range As Tuple(Of Integer, Integer) In ranges
                ...
                While remaining > 0
                    ...
                    Dim wordsThisBlock As Integer =
                        Math.Min(
                            CalRam3458ABlockWords,
                            remaining)
                    ...
                    Dim progress As Integer =
                        50 +
                        CInt((completedWords / 1024.0) * 45.0)

                    Set3458ACalRamWriteProgress(
                        progress,
                        "WRITING CALRAM BLOCK " &
                        blockNumber.ToString(
                            CultureInfo.InvariantCulture) &
                        " - " &
                        wordsThisBlock.ToString(
                            CultureInfo.InvariantCulture) &
                        " WORDS")

                    If Not Write3458ACalRamBlock(
                        config,
                        position,
                        wordsThisBlock) Then

                        Throw New InvalidOperationException(
                            "The HP 3458A reported an error while writing " &
                            "CalRAM block " &
                            blockNumber.ToString(
                                CultureInfo.InvariantCulture) &
                            ".")
            ...
            For checksumNumber As Integer =
                0 To checksumWordIndexes.Count - 1
                ...
                Dim checksumIndex As Integer =
                    checksumWordIndexes(checksumNumber)

                Set3458ACalRamWriteProgress(
                    96 + checksumNumber,
                    "WRITING CALRAM CHECKSUM " &
                    (checksumNumber + 1).ToString(
                        CultureInfo.InvariantCulture) &
                    " / 4")
            ...
            Set3458ACalRamWriteProgress(
                100,
                "CALRAM WRITE COMPLETE - READY TO VERIFY")

            Button3458ACalRamVerify.Enabled = True

            MessageBox.Show(
                "The complete 2048-byte CalRAM image was written." &
                vbCrLf & vbCrLf &
                "Press VERIFY to read the CalRAM back and compare every byte.",
                "HP 3458A CalRAM",
                MessageBoxButtons.OK,
                MessageBoxIcon.Information)
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(
                "The HP 3458A CalRAM write failed." &
                vbCrLf & vbCrLf &
                ex.Message,
                "HP 3458A CalRAM",
                MessageBoxButtons.OK,
        ...
        Finally
            ...
            If Label3458ACalRamStatus.Text =
               "CALRAM WRITE COMPLETE - READY TO VERIFY" Then
    ...
    Private Sub Button3458ACalRamVerify_Click(
    sender As Object,
    e As EventArgs) Handles Button3458ACalRamVerify.Click
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(
                "The selected CalRAM file could not be read." &
                vbCrLf & vbCrLf &
                ex.Message,
                "HP 3458A CalRAM",
                MessageBoxButtons.OK,
        ...
        Try
            ...
            Dim differences As New List(
                Of Tuple(Of Integer, Byte, Byte))
            ...
            For byteIndex As Integer = 0 To 2047
                ...
                Dim physicalAddress As Integer =
                    CalRam3458ABase + (byteIndex * 2)

                Dim actualValue As Byte =
                    CByte(MRead3458AHighByte(physicalAddress))

                Dim expectedValue As Byte =
                    expectedData(byteIndex)
            ...
            If differences.Count = 0 Then
                ...
                Label3458ACalRamStatus.Text =
                    "CALRAM VERIFIED - 2048 BYTES MATCH"
                ...
                MessageBox.Show(
    "CALRAM VERIFY PASSED" &
    vbCrLf & vbCrLf &
    "All 2048 bytes in the HP 3458A match the selected file.",
    "HP 3458A CalRAM",
    MessageBoxButtons.OK,
    MessageBoxIcon.Information)
            ...
            Else
                ...
                Label3458ACalRamStatus.Text =
                    "CALRAM VERIFY FAILED - " &
                    differences.Count.ToString(
                        CultureInfo.InvariantCulture) &
                    " BYTE DIFFERENCES"
                ...
                For index As Integer = 0 To reportCount - 1
                    ...
                    Dim physicalAddress As Integer =
                        CalRam3458ABase + (offset * 2)

                    report.AppendLine(
                        "Offset 0x" &
                        offset.ToString("X4") &
                        "  Address 0x" &
                        physicalAddress.ToString("X6") &
                        "  File 0x" &
                        difference.Item2.ToString("X2") &
                        "  Meter 0x" &
        ...
        Catch ex As OperationCanceledException
            ...
            Label3458ACalRamStatus.Text =
                "CALRAM VERIFY ABORTED"

            ProgressBar3458ACalRam.Value = 0

            MessageBox.Show(
                "The CalRAM verification was aborted.",
                "HP 3458A CalRAM",
                MessageBoxButtons.OK,
                MessageBoxIcon.Warning)
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(
                "The HP 3458A CalRAM verification failed." &
                vbCrLf & vbCrLf &
                ex.Message,
                "HP 3458A CalRAM",
                MessageBoxButtons.OK,
        ...
        Finally
            ...
            If Label3458ACalRamStatus.Text =
               "CALRAM VERIFIED - 2048 BYTES MATCH" Then
...
vbCrLf & vbCrLf &
"4. Press WRITE CALRAM. The selected CalRAM image is first loaded into temporary RAM inside the meter, then copied into the protected CalRAM. The four checksum words are written last." &
vbCrLf & vbCrLf &
