...
Partial Class Formtest
    ...
    Private Sub ButtonLiveChartPopout_Click(sender As Object, e As EventArgs) Handles ButtonLiveChartPopout.Click
        ...
        Dim RefreshDeviceAvailability = Sub()
                                            ...
                                            ' A device run starting from nothing running restarts the sample counter, so the counter is reset and the
            ' Temperature trace (which shares it) is cleared too; otherwise it carries on from the previous run.
            If (dev1Active AndAlso Not dev1WasActive OrElse dev2Active AndAlso Not dev2WasActive) AndAlso Not (dev1WasActive OrElse dev2WasActive) Then
